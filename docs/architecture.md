...
| `edition`         | `id`, `work_id`, `title`, `language`, `translator`, `publisher`, `year`, `isbn13`, `natural_key`, `source_id` | `natural_key` = ISBN-13, если есть; иначе хэш(work_id, language, publisher, year, norm(title)) |
