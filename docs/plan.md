...
**Обозначения:** ✅ сделано · 🚧 в работе · ⬜ не начато. Текущий статус проекта: **Фаза 1 (MVP)
завершена целиком** — 0, 1.0–1.6 все закрыты (гипотеза подтверждена, см.
[coverage-phase0.md](research/coverage-phase0.md)). Следующая — Фаза 2 (расширение покрытия).
...
- [x] Диплинки на легальное заимствование — Open Library Lending: `OpenLibraryProvider` вызывает
...
- [x] Приоритеты источников при конфликте полей, отражение источника факта в UI —
...
- [x] Нагрузочный тест поиска и карточки, оптимизация индексов по результатам — прогнан на
