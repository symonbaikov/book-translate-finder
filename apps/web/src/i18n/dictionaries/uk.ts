...
export const uk: Dictionary = {
  ...
  'tour.skip': 'Не зараз',
  'tour.finish': 'Готово',
  'tour.close': 'Закрити тур',
  'tour.welcome.title': 'Ласкаво просимо до Golden Library',
  'tour.welcome.text':
    'Хвилина — і ви знатимете, що тут де. Сайт показує, якими мовами існує книжка і де взяти її легально, і робить це тим краще, чим точніше ви скажете, де шукати. Із цього й почнемо.',
  'tour.customSourcesNav.title': 'Почніть із власних джерел',
  'tour.customSourcesNav.text':
    'Відкрийте <strong>Власні джерела</strong> — сторінку, де ви вирішуєте, які каталоги шукати поряд із вбудованими.',
  'tour.presets.title': 'Писати з нуля не обовʼязково',
  'tour.presets.text':
    'Тут публікують готові шаблони. Вони належать тим, хто їх написав: сайт нічого в тому каналі не перевіряє, а додане джерело шукає з вашого браузера, а не з цього сервера. Відкрийте канал у новій вкладці, візьміть потрібне й повертайтеся.',
  'tour.sourceForm.title': 'Два поля — і все',
  'tour.sourceForm.text':
    'Зрозуміла вам назва й адреса пошуку, де <strong>{query}</strong> стоїть на місці ваших слів. Додайте джерело зараз або натисніть «Далі» й поверніться до цього згодом.',
  'tour.sourceList.title': 'Усе додане лишається тут',
  'tour.sourceList.text':
    'Ваші джерела перелічені нижче, кожне можна вимкнути або видалити. Вони зберігаються в цьому браузері й ніколи не надсилаються на сервер: тут їх ніхто не бачить, а на іншому пристрої їх не буде.',
  'tour.addonsNav.title': 'Додатки йдуть далі',
  'tour.addonsNav.text':
    'Відкрийте <strong>Додатки</strong>. Власне джерело — це одна написана вами адреса, а додаток — невелика програма, написана кимось іншим, яка вміє шукати в каталозі по-справжньому.',
  'tour.addons.title': 'Нічого не встановлюється, доки ви не подивилися',
  'tour.addons.text':
    'Вставте адресу додатка — і форма покаже, що це і з якими хостами він спілкуватиметься; лише після цього він встановлюється. Його результати завжди підписані назвою додатка, який їх видав.',
  'tour.shelfNav.title': 'Полиця',
  'tour.shelfNav.text':
    'Відкрийте <strong>Полицю</strong>, щоб побачити каталоги, з яких можна читати напряму.',
  'tour.shelf.title': 'Відкриті каталоги й ваші власні',
  'tour.shelf.text':
    '«Проєкт Ґутенберг» і подібні до нього є тут одразу. Нижче можна додати будь-який каталог OPDS — наприклад, сервер Calibre у вашій мережі: до нього дотягується ваш браузер, а цей сайт — ніколи.',
  'tour.language.title': 'Пʼятнадцять мов',
  'tour.language.text':
    'Мову інтерфейсу можна змінити тут будь-коли. Як і кожне налаштування на цьому сайті, вона записується у ваш браузер і діє відразу — і повідомляє про це спливним вікном, зокрема коли браузер відмовився її запамʼятати.',
  'tour.done.title': 'Ось і весь тур',
  'tour.done.text':
    'Шукайте з головної сторінки, а якщо хочете зберігати знайдені книжки — увійдіть. Посилання внизу будь-якої сторінки запускає цей тур наново.',
  'settings.tour.title': 'Оглядовий тур',
  'settings.tour.finished':
    'Ви пройшли тур, і сам він більше не відкриється. Посилання внизу сторінки запускає його, коли захочете.',
  'settings.tour.skipped':
    'Тур закрито, і сам він більше не відкриється. Посилання внизу сторінки запускає його, коли захочете.',
  'settings.tour.restarted': 'Починаємо з першого кроку; цей браузер забув, що ви тур уже бачили.',
  'customSources.presets': 'Готові шаблони',
  'customSources.presetsCaption':
    'Шаблони, якими діляться інші читачі, у каналі цього примірника сайту. Тут їх ніхто не перевіряє: прочитайте шаблон, перш ніж додавати, і памʼятайте, що шукати він буде з вашого браузера.',
