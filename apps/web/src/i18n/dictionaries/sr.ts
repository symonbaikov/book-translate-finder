...
export const sr: Dictionary = {
  ...
  'tour.skip': 'Не сада',
  'tour.finish': 'Готово',
  'tour.close': 'Затвори обилазак',
  'tour.welcome.title': 'Добро дошли у Golden Library',
  'tour.welcome.text':
    'Минут и знаћете где је шта. Овај сајт проналази на којим језицима књига постоји и где је набавити легално — а то чини тим боље што му тачније кажете где да тражи. Одатле и почињемо.',
  'tour.customSourcesNav.title': 'Почните од сопствених извора',
  'tour.customSourcesNav.text':
    'Отворите <strong>Сопствени извори</strong> — страницу на којој одлучујете који се каталози претражују уз уграђене.',
  'tour.presets.title': 'Не морате писати од нуле',
  'tour.presets.text':
    'Тамо се објављују готови обрасци. Припадају онима који су их написали: овај сајт на том каналу ништа не проверава, а извор који додате претражује из вашег прегледача, а не са овог сервера. Отворите у новој картици, узмите шта вам треба и вратите се.',
  'tour.sourceForm.title': 'Два поља и готово',
  'tour.sourceForm.text':
    'Назив који ћете препознати и адреса претраге у којој <strong>{query}</strong> стоји на месту ваших речи. Додајте један сада или притисните «Даље» па се вратите касније.',
  'tour.sourceList.title': 'Све што додате остаје овде',
  'tour.sourceList.text':
    'Ваши извори наведени су испод и сваки се може искључити или уклонити. Живе у овом прегледачу и никада не одлазе на сервер: овде их нико не види, а на другом уређају их неће бити.',
  'tour.addonsNav.title': 'Додаци иду даље',
  'tour.addonsNav.text':
    'Отворите <strong>Додаци</strong>. Сопствени извор је једна адреса коју сте написали; додатак је мали програм који је написао неко други и који заиста уме да претражује каталог.',
  'tour.addons.title': 'Ништа се не инсталира док то не видите',
  'tour.addons.text':
    'Налепите адресу додатка и овај образац показује шта је и са којим ће серверима разговарати; тек онда се инсталира. Његови резултати увек носе име додатка који их је дао.',
  'tour.shelfNav.title': 'Полица',
  'tour.shelfNav.text':
    'Отворите <strong>Полицу</strong> да видите каталоге из којих можете читати непосредно.',
  'tour.shelf.title': 'Отворени каталози и ваши сопствени',
  'tour.shelf.text':
    'Пројекат Гутенберг и њему слични ту су од почетка. Испод можете додати било који OPDS каталог — на пример Calibre сервер у вашој мрежи: до њега допире ваш прегледач, а овај сајт никада.',
  'tour.language.title': 'Језик сучеља',
  'tour.language.text':
    'Мењајте га овде кад год желите. Као и свако подешавање овде, уписује се у ваш прегледач и важи одмах — и то каже у обавештењу, па и онда кад је прегледач одбио да га запамти.',
  'tour.done.title': 'То је био обилазак',
  'tour.done.text':
    'Тражите са почетне странице, а пријавите се ако желите да се пронађене књиге сачувају. Веза на дну сваке странице поново покреће овај обилазак.',
  'settings.tour.title': 'Вођени обилазак',
  'settings.tour.finished':
    'Прошли сте обилазак, па се више неће отворити сам. Веза на дну странице покреће га кад год пожелите.',
  'settings.tour.skipped':
    'Обилазак је затворен и више се неће отворити сам. Веза на дну странице покреће га кад год пожелите.',
  'settings.tour.restarted':
    'Крећемо поново од првог корака, а овај прегледач је заборавио да сте га већ видели.',
  'customSources.presets': 'Готови обрасци',
  'customSources.presetsCaption':
    'Обрасци које деле други читаоци, на каналу ове инстанце. Овде их нико не проверава: прочитајте образац пре него што га додате и запамтите да ће претраживати из вашег прегледача.',
  'footer.takeTheTour': 'Крените у обилазак',
};
