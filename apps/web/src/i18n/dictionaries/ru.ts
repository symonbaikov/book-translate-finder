...
export const ru: Dictionary = {
  ...
  'tour.welcome.title': 'Добро пожаловать в Golden Library',
  'tour.welcome.text':
    'Минута — и вы будете знать, что здесь где. Сайт показывает, на какие языки переведена книга и где взять её легально, и делает это тем лучше, чем точнее вы укажете, где искать. С этого и начнём.',
  'tour.customSourcesNav.title': 'Начните со своих источников',
  'tour.customSourcesNav.text':
    'Откройте <strong>Свои источники</strong> — страницу, где вы решаете, какие каталоги искать вместе со встроенными.',
  'tour.presets.title': 'Писать с нуля не обязательно',
  'tour.presets.text':
    'Здесь публикуются готовые шаблоны. Они принадлежат тем, кто их написал: сайт ничего в этом канале не проверяет, а добавленный источник ищет из вашего браузера, а не с этого сервера. Откройте канал в новой вкладке, возьмите нужное и возвращайтесь.',
  'tour.sourceForm.title': 'Два поля — и всё',
  'tour.sourceForm.text':
    'Понятное вам название и адрес поиска, где <strong>{query}</strong> стоит на месте ваших слов. Добавьте источник сейчас или нажмите «Дальше» и вернитесь к этому позже.',
  'tour.sourceList.title': 'Всё добавленное остаётся здесь',
  'tour.sourceList.text':
    'Ваши источники перечислены ниже, каждый можно выключить или удалить. Они хранятся в этом браузере и никогда не отправляются на сервер: здесь их никто не видит, а на другом устройстве их не будет.',
  'tour.addonsNav.title': 'Аддоны идут дальше',
  'tour.addonsNav.text':
    'Откройте <strong>Аддоны</strong>. Свой источник — это один написанный вами адрес, а аддон — небольшая программа, написанная кем-то другим, которая умеет искать в каталоге по-настоящему.',
  'tour.addons.title': 'Ничего не ставится, пока вы не посмотрели',
  'tour.addons.text':
    'Вставьте адрес аддона — и форма покажет, что это и с какими хостами он будет общаться; только после этого он устанавливается. Его результаты всегда подписаны именем аддона, который их выдал.',
  'tour.shelfNav.title': 'Полка',
  'tour.shelfNav.text':
    'Откройте <strong>Полку</strong>, чтобы увидеть каталоги, из которых можно читать напрямую.',
  'tour.shelf.title': 'Открытые каталоги и ваши собственные',
  'tour.shelf.text':
    '«Проект Гутенберг» и ему подобные есть здесь сразу. Ниже можно добавить любой каталог OPDS — например, сервер Calibre в вашей сети: до него дотягивается ваш браузер, а этот сайт — никогда.',
  'tour.language.title': 'Пятнадцать языков',
  'tour.language.text':
    'Язык интерфейса меняется здесь в любой момент. Как и всякая настройка на этом сайте, он записывается в ваш браузер и действует сразу — и сообщает об этом всплывающим окном, в том числе когда браузер отказался его запомнить.',
  'tour.done.title': 'Вот и весь тур',
  'tour.done.text':
    'Ищите с главной страницы, а если хотите сохранять найденные книги — войдите. Ссылка внизу любой страницы запускает этот тур заново.',
  'settings.tour.title': 'Обзорный тур',
  'settings.tour.finished':
    'Вы прошли тур, и сам он больше не откроется. Ссылка внизу страницы запускает его, когда захотите.',
  'settings.tour.skipped':
    'Тур закрыт и сам больше не откроется. Ссылка внизу страницы запускает его, когда захотите.',
  'settings.tour.restarted': 'Начинаем с первого шага; этот браузер забыл, что вы тур уже видели.',
  'customSources.presets': 'Готовые шаблоны',
  'customSources.presetsCaption':
    'Шаблоны, которыми делятся другие читатели, в канале этого экземпляра сайта. Здесь их никто не проверяет: прочитайте шаблон, прежде чем добавлять, и помните, что искать он будет из вашего браузера.',
  'footer.takeTheTour': 'Пройти тур',
};
