...
export const bg: Dictionary = {
  ...
  'home.genres': 'Популярни жанрове',
  'home.genresBlurb': 'Етикетите с най-много книги зад тях. Всеки от тях отваря своя каталог.',
  ...
  'tour.skip': 'Не сега',
  'tour.finish': 'Готово',
  'tour.close': 'Затваряне на обиколката',
  'tour.welcome.title': 'Добре дошли в Golden Library',
  'tour.welcome.text':
    'Една минута и ще знаете къде какво е. Сайтът открива на кои езици съществува дадена книга и къде да я получите законно — и го прави толкова по-добре, колкото по-точно му кажете къде да търси. Оттам започваме.',
  'tour.customSourcesNav.title': 'Започнете със собствените си източници',
  'tour.customSourcesNav.text':
    'Отворете <strong>Собствени източници</strong> — страницата, на която решавате кои каталози се претърсват освен вградените.',
  'tour.presets.title': 'Не е нужно да пишете от нулата',
  'tour.presets.text':
    'Там се публикуват готови шаблони. Те принадлежат на тези, които са ги написали: сайтът не проверява нищо в този канал, а източник, който добавите, търси от вашия браузър, а не от този сървър. Отворете в нов раздел, вземете каквото ви трябва и се върнете.',
  'tour.sourceForm.title': 'Две полета и готово',
  'tour.sourceForm.text':
    'Име, което ще разпознаете, и адрес на търсене, в който <strong>{query}</strong> стои на мястото на вашите думи. Добавете един сега или натиснете «Напред» и се върнете по-късно.',
  'tour.sourceList.title': 'Всичко добавено остава тук',
  'tour.sourceList.text':
    'Вашите източници са изброени по-долу и всеки може да бъде изключен или премахнат. Живеят в този браузър и никога не отиват към сървъра: тук никой не ги вижда, а на друго устройство няма да ги има.',
  'tour.addonsNav.title': 'Добавките отиват по-далеч',
  'tour.addonsNav.text':
    'Отворете <strong>Добавки</strong>. Собственият източник е един адрес, който сте написали; добавката е малка програма от някой друг, която може наистина да претърси каталог.',
  'tour.addons.title': 'Нищо не се инсталира, преди да сте го видели',
  'tour.addons.text':
    'Поставете адреса на добавка и формата показва какво е тя и с кои хостове ще говори; чак тогава се инсталира. Резултатите ѝ винаги носят името на добавката, която ги е дала.',
  'tour.shelfNav.title': 'Рафтът',
  'tour.shelfNav.text':
    'Отворете <strong>Рафт</strong>, за да видите каталозите, от които можете да четете директно.',
  'tour.shelf.title': 'Отворени каталози и вашите собствени',
  'tour.shelf.text':
    'Проект Гутенберг и подобните му са тук от самото начало. Отдолу можете да добавите всеки OPDS каталог — например сървър Calibre във вашата мрежа: до него стига вашият браузър, а този сайт — никога.',
  'tour.language.title': 'Езикът на интерфейса',
  'tour.language.text':
    'Сменяйте го оттук, когато поискате. Като всяка настройка тук се записва в браузъра ви и важи веднага — и го казва в известие, включително когато браузърът откаже да я запази.',
  'tour.done.title': 'Това беше обиколката',
  'tour.done.text':
    'Търсете от началната страница и влезте в профила си, ако искате намерените книги да се пазят. Връзката в долния край на всяка страница пуска тази обиколка отново.',
  'settings.tour.title': 'Обиколката с водач',
  'settings.tour.finished':
    'Преминахте обиколката, така че тя няма да се отвори сама отново. Връзката долу на страницата я пуска, когато поискате.',
  'settings.tour.skipped':
    'Обиколката е затворена и няма да се отвори сама отново. Връзката долу на страницата я пуска, когато поискате.',
  'settings.tour.restarted':
    'Започваме отново от първата стъпка, а този браузър забрави, че вече сте я виждали.',
  'customSources.presets': 'Готови шаблони',
  'customSources.presetsCaption':
    'Шаблони, които други читатели споделят, в канала на този сайт. Тук никой не ги проверява: прочетете шаблона, преди да го добавите, и помнете, че ще търси от вашия браузър.',
  'footer.takeTheTour': 'Направете обиколката',
};
