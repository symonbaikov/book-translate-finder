...
export const mk: Dictionary = {
  ...
  'tour.skip': 'Не сега',
  'tour.finish': 'Готово',
  'tour.close': 'Затвори ја турата',
  'tour.welcome.title': 'Добре дојдовте во Golden Library',
  'tour.welcome.text':
    'Една минута и ќе знаете каде е што. Сајтот наоѓа на кои јазици постои книгата и каде да ја добиете легално — а тоа го прави толку подобро колку попрецизно ќе му кажете каде да бара. Оттаму и почнуваме.',
  'tour.customSourcesNav.title': 'Почнете од сопствените извори',
  'tour.customSourcesNav.text':
    'Отворете <strong>Сопствени извори</strong> — страницата на која одлучувате кои каталози се пребаруваат покрај вградените.',
  'tour.presets.title': 'Не мора да пишувате од нула',
  'tour.presets.text':
    'Таму се објавуваат готови шаблони. Им припаѓаат на оние што ги напишале: овој сајт не проверува ништо на тој канал, а изворот што ќе го додадете бара од вашиот прелистувач, а не од овој сервер. Отворете во ново јазиче, земете го потребното и вратете се.',
  'tour.sourceForm.title': 'Две полиња и готово',
  'tour.sourceForm.text':
    'Име што ќе го препознаете и адреса на пребарување во која <strong>{query}</strong> стои на местото на вашите зборови. Додајте еден сега или притиснете «Натаму» и вратете се подоцна.',
  'tour.sourceList.title': 'Сè што ќе додадете останува тука',
  'tour.sourceList.text':
    'Вашите извори се наведени подолу и секој може да се исклучи или отстрани. Живеат во овој прелистувач и никогаш не одат на серверот: тука никој не ги гледа, а на друг уред нема да ги има.',
  'tour.addonsNav.title': 'Додатоците одат подалеку',
  'tour.addonsNav.text':
    'Отворете <strong>Додатоци</strong>. Сопствениот извор е една адреса што сте ја напишале; додатокот е мала програма напишана од некој друг, што вистински умее да пребарува каталог.',
  'tour.addons.title': 'Ништо не се инсталира пред да го видите',
  'tour.addons.text':
    'Залепете адреса на додаток и формуларот ќе ви покаже што е и со кои сервери ќе разговара; дури потоа се инсталира. Неговите резултати секогаш го носат името на додатокот што ги дал.',
  'tour.shelfNav.title': 'Полица',
  'tour.shelfNav.text':
    'Отворете ја <strong>Полицата</strong> за да ги видите каталозите од кои може директно да читате.',
  'tour.shelf.title': 'Отворени каталози и вашите сопствени',
  'tour.shelf.text':
    'Проектот Гутенберг и нему сличните се тука од самиот почеток. Подолу може да додадете кој било OPDS каталог — на пример Calibre сервер во вашата мрежа: до него допира вашиот прелистувач, а овој сајт никогаш.',
  'tour.language.title': 'Јазикот на интерфејсот',
  'tour.language.text':
    'Менувајте го тука кога сакате. Како и секое поставување тука, се запишува во вашиот прелистувач и важи веднаш — и тоа го кажува во известување, вклучително и кога прелистувачот одбил да го запамети.',
  'tour.done.title': 'Тоа беше турата',
  'tour.done.text':
    'Барајте од почетната страница, а најавете се ако сакате најдените книги да се зачуваат. Врската на дното на секоја страница ја стартува оваа тура одново.',
  'settings.tour.title': 'Водена тура',
  'settings.tour.finished':
    'Ја поминавте турата, па повеќе нема да се отвори сама. Врската на дното на страницата ја стартува кога ќе посакате.',
  'settings.tour.skipped':
    'Турата е затворена и повеќе нема да се отвори сама. Врската на дното на страницата ја стартува кога ќе посакате.',
  'settings.tour.restarted':
    'Почнуваме од првиот чекор, а овој прелистувач заборави дека веќе сте ја виделе.',
  'customSources.presets': 'Готови шаблони',
  'customSources.presetsCaption':
    'Шаблони што ги споделуваат други читатели, на каналот на овој сајт. Тука никој не ги проверува: прочитајте го шаблонот пред да го додадете и запомнете дека ќе бара од вашиот прелистувач.',
  'footer.takeTheTour': 'Поминете низ турата',
};
